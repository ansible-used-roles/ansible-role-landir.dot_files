...
sudo env PATH=$PATH ansible-pull -U https://github.com/ansible-used-roles/ansible-role-landir.dot_files -d /etc/ansible/roles/ansible-role-landir.dot_files -i scripts/localinventory default.yml
